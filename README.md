...
# GIF-SearchEngine
Day 27: A web GIF search engine. You can search and download any GIF's you want to make use of.

https://anayooleru.github.io/GIF-SearchEngine/
...
- Clone the repository to your computer ensure to run the command below in the directory you want to store the project.
    # git clone https://github.com/AnayoOleru/GIF-SearchEngine.git
```
